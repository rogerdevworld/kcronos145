...
class Documentales(models.Model):
    ...
    image=models.ImageField(upload_to='Documentales/',null=False)
...
class ImagesDocumentales(models.Model):
    documentales=models.ForeignKey(Documentales,on_delete=models.CASCADE)
