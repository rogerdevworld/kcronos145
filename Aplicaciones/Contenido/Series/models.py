...
class Series(models.Model):
    ...
    genero = models.ForeignKey(Categorias, on_delete=models.CASCADE,null = True,blank=True) #many to one relation with Category
    ...
    image=models.ImageField(upload_to='Series/',null=False)
...
class ImagesSeries(models.Model):
    series=models.ForeignKey(Series,on_delete=models.CASCADE)
    title = models.CharField(max_length=50,blank=True)
    image = models.ImageField(blank=True, upload_to='Partes Series/')
